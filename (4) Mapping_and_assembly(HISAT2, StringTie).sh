...
do 
	...
	echo $output
    stringtie $bam_files  -P 8 -G /mnt/nemahomes/steen176/pallida/G_pallida_D383_v.0.8.1.structural_annotation_minus_scaffold_93A.renamed.gff -o $output -A /mnt/nemahomes/shaky005/RNAseq_data/stringtie_pal/pal_abundance.tab 
done
...
do
	...
	echo $output
	stringtie $bam_files  -P 8 -G /mnt/nemahomes/steen176/Annotation/G_ros19/braker_results/augustus.hints.gff3 -o $output -A /mnt/nemahomes/shaky005/RNAseq_data/stringtie_rosto/rosto_abundance.tab
done